...
set MASMPATH=Z:\Users\paulfarcasanu\wine-masm\drive_c\masm32\bin
...
set MASMLIBPATH=Z:\Users\paulfarcasanu\wine-masm\drive_c\masm32\lib
...
set MASMINCPATH=Z:\Users\paulfarcasanu\wine-masm\drive_c\masm32\include
